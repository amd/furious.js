...
extern "C" enum FJS_Error FJS_DispatchRequest(PP_Instance instance, const void* requestPointer, size_t requestSize) {
	...
	switch (requestType) {
		...
		{
			const furious::EmptyArrayRequest& emptyArrayRequest = request.emptyarrayrequest();
		...
		{
			const furious::DataArrayRequest& dataArrayRequest = request.dataarrayrequest();
			const struct FJS_Shape shape = {
		...
		{
			const furious::ConstArrayRequest& constArrayRequest = request.constarrayrequest();
			const struct FJS_Shape shape = {
		...
		{
			const furious::LinspaceRequest& linspaceRequest = request.linspacerequest();
		...
		{
			const furious::ReshapeRequest& reshapeRequest = request.reshaperequest();
		...
		{
			const furious::RepeatRequest& repeatRequest = request.repeatrequest();
		...
		{
			const furious::DeallocateRequest& deallocateRequest = request.deallocaterequest();
		...
		case furious::Request_Type_FETCH:
		{
			...
			const furious::FetchRequest& fetchRequest = request.fetchrequest();
		...
		{
			const furious::BinaryOperationRequest& binaryOperationRequest = request.binaryoperationrequest();
		...
		{
			const furious::BinaryConstOperationRequest& binaryConstOperationRequest = request.binaryconstoperationrequest();
		...
		{
			const furious::UnaryOperationRequest& unaryOperationRequest = request.unaryoperationrequest();
		...
		{
			const furious::ReductionRequest& reductionRequest = request.reductionrequest();
		...
		{
			const furious::AxisReductionRequest& axisReductionRequest = request.axisreductionrequest();
		...
		{
			const furious::DotOperationRequest& dotOperationRequest = request.dotoperationrequest();
