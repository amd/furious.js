 ...
 */
exports.array = function(data, dataType) {
	var shape = [];
 ...
 */
exports.abs = function(input, output) {
 ...
 */
exports.exp = function(input, output) {
	if (!(input instanceof NDArray)) {
		throw new TypeError(input + " is not an NDArray");
	}
	if (typeof output === 'undefined') {
 ...
 */
exports.log = function(input, output) {
	if (!(input instanceof NDArray)) {
		throw new TypeError(input + " is not an NDArray");
	}
	if (typeof output === 'undefined') {
 ...
 * @param {NDArray=} output - the array for the logarithm value values. If supplied, must match the dimensions of the `input` array.
 */
exports.dot = function(a, b, output) {
 ...
 */
exports.linspace = function(start, stop, samples, includeStop) {
