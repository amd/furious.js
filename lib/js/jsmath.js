...
var expm1_es5 = function(dataA, dataOut) {
	var n = dataOut.length;
	for (var i = 0; i < n; ++i) {
...
var expm1_es6 = function(dataA, dataOut) {
	var n = dataOut.length;
	for (var i = 0; i < n; ++i) {
...
exports.expm1 = function(dataA, dataOut) {
	if (typeof Math.expm1 !== "undefined") {
		expm1_es6(dataA, dataOut);
	} else {
		expm1_es5(dataA, dataOut);
	}
};
...
var log10_es5 = function(dataA, dataOut) {
	var n = dataOut.length;
	for (var i = 0; i < n; ++i) {
...
var log10_es6 = function(dataA, dataOut) {
	var n = dataOut.length;
	for (var i = 0; i < n; ++i) {
...
exports.log10 = function(dataA, dataOut) {
	if (typeof Math.log10 !== "undefined") {
		log10_es6(dataA, dataOut);
	} else {
		log10_es5(dataA, dataOut);
	}
};

var log1p_es5 = function(dataA, dataOut) {
	var n = dataOut.length;
	for (var i = 0; i < n; ++i) {
...
var log1p_es6 = function(dataA, dataOut) {
	var n = dataOut.length;
	for (var i = 0; i < n; ++i) {
...
exports.log1p = function(dataA, dataOut) {
	if (typeof Math.log1p !== "undefined") {
		log1p_es6(dataA, dataOut);
	} else {
		log1p_es5(dataA, dataOut);
	}
};
...
var trunc_es5 = function(dataA, dataOut) {
	var n = dataOut.length;
	for (var i = 0; i < n; ++i) {
		var a = dataA[i];
...
var trunc_es6 = function(dataA, dataOut) {
	var n = dataOut.length;
	for (var i = 0; i < n; ++i) {
...
exports.trunc = function(dataA, dataOut) {
	if (typeof Math.trunc !== "undefined") {
		trunc_es5(dataA, dataOut);
	} else {
		trunc_es6(dataA, dataOut);
	}
};
