...
exports.log10 = function(dataA, dataOut) {
	var n = dataOut.length;
	for (var i = 0; i < n; ++i) {
		dataOut[i] = Math.log(dataA[i])/Math.log(10);
	}
};
...
exports.fix = function(dataA, dataOut) {
	var n = dataOut.length;
	for (var i = 0; i < n; ++i) {
			dataOut[i] = dataA[i].toFixed(0);
	}
};
