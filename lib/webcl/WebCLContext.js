...
function WebCLContext(callback) {
	...
	var source = binaryKernelsSource + unaryKernelsSource + reductionKernelsSource + utilKernelsSource;
...
WebCLContext.prototype.min = function(a, axis, out) {
	return axisReduceOp(a, axis, out, this, this.kernels.min, null);
};

WebCLContext.prototype.max = function(a, axis, out) {
	return axisReduceOp(a, axis, out, this, this.kernels.max, null);
};

WebCLContext.prototype.sum = function(a, axis, out) {
	return axisReduceOp(a, axis, out, this, this.kernels.sum, null);
};
