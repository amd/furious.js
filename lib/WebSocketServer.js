...
ConnectionContext.prototype.createDataArray =
    function(requestId, idOut, shape, dataType, dataBuffer) {
...
ConnectionContext.prototype.linspace =
    function (requestId, idOut, start, stop, samples, closed, dataType) {
    if (idOut in this.idMap) {
...
ConnectionContext.prototype.deallocate =
...
ConnectionContext.prototype.fetch =
